    ...
    <main className="flex flex-col font-sans">
      <section className="relative overflow-hidden py-24 text-center space-y-6 bg-secondary">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          All-in-one platform crafted by veteran organizers to make every live
          event unforgettable
        </p>
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto overflow-x-auto flex gap-6 snap-x snap-mandatory pb-4 scroll-smooth">
